-- =============================================================================
-- STORED PROCEDURE: dbo.PR_UPDATE_PRODUCT_PRICE
-- Description: Updates product price with price history tracking (Option B).
-- =============================================================================

CREATE OR ALTER PROCEDURE dbo.PR_UPDATE_PRODUCT_PRICE
(
    @PRODUCT_ID           BIGINT,
    @PRICE                DECIMAL(18,2),
