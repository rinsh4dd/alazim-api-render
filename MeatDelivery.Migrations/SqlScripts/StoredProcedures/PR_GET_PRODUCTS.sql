...
-- Description: Unified all-in-one retrieval for products supporting Guest, User,
--              and Admin modes with bilingual search, filtering, pagination,
--              GetById, wishlist status, and recent order status.
-- =============================================================================
...
BEGIN
    ...
    -- Mode Defaults for GUEST and USER
    ...
    -- Temporary table for paged product IDs
    ...
    -- Common CTE for filtered base products
