-- =============================================================================
-- STORED PROCEDURE: dbo.PR_GET_AVAILABLE_DELIVERY_SLOTS
-- Description: Dynamically generates available 1-hour delivery time slots based on COMPANY_CONFIG delivery timings, excluding holidays and passed time.
-- =============================================================================
