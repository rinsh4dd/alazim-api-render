-- =============================================================================
-- STORED PROCEDURE: dbo.PR_GET_CUSTOMIZATION_OPTIONS
-- Description: Retrieves paginated customization options supporting search (@SEARCH),
--              filtering by CustomizationGroupId, CustomizationOptionId (GetById), and IsActive status.
-- =============================================================================
...
BEGIN
    ...
    -- Result Set 2: Paged Customization Options
    SELECT 
