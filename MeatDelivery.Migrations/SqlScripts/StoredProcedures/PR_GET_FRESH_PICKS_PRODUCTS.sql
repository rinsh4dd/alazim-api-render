-- =============================================================================
-- STORED PROCEDURE: dbo.PR_GET_FRESH_PICKS_PRODUCTS
-- Description: Retrieves all active, non-deleted fresh arrival products.
-- =============================================================================

CREATE OR ALTER PROCEDURE dbo.PR_GET_FRESH_PICKS_PRODUCTS
AS
BEGIN
    SET NOCOUNT ON;
