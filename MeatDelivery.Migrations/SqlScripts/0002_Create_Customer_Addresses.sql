...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('dbo.CUSTOMER_ADDRESSES') AND name = 'FIRST_NAME')
BEGIN
    ALTER TABLE dbo.CUSTOMER_ADDRESSES ADD FIRST_NAME NVARCHAR(100) NULL;
END
GO

IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('dbo.CUSTOMER_ADDRESSES') AND name = 'LAST_NAME')
BEGIN
    ALTER TABLE dbo.CUSTOMER_ADDRESSES ADD LAST_NAME NVARCHAR(100) NULL;
END
GO
