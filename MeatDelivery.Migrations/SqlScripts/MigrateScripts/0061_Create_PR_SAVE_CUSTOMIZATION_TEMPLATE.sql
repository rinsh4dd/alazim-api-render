...
-- Migration: 0061_Create_PR_SAVE_CUSTOMIZATION_TEMPLATE.sql
-- Description: Creates stored procedure dbo.PR_SAVE_CUSTOMIZATION_TEMPLATE for managing Customization Templates (ADD, EDIT, DELETE).
