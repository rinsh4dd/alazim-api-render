-- =============================================================================
-- Migration: 0081_Create_TT_CUSTOMIZATION_OPTION_IDS_And_PR_SAVE_CART_ITEM.sql
-- Description: Creates TVP dbo.TT_CUSTOMIZATION_OPTION_IDS and procedure dbo.PR_SAVE_CART_ITEM
-- =============================================================================

IF NOT EXISTS (SELECT 1 FROM sys.types WHERE name = 'TT_CUSTOMIZATION_OPTION_IDS' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    CREATE TYPE dbo.TT_CUSTOMIZATION_OPTION_IDS AS TABLE
    (
...
CREATE OR ALTER PROCEDURE dbo.PR_SAVE_CART_ITEM
(
    @MODE VARCHAR(10),
