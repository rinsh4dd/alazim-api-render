-- =============================================================================
-- Migration: 0022_Create_PR_GET_CATEGORIES.sql
-- Description: Creates stored procedure PR_GET_CATEGORIES supporting pagination,
--              search, filtering, and sorting for category listing.
-- =============================================================================
...
BEGIN
    ...
    SELECT 
        ...
        p.CATEGORY_NAME_EN AS ParentCategoryNameEn,
