-- Migration: 0045_Create_PR_GET_PRODUCTS.sql
-- Description: Creates stored procedure PR_GET_PRODUCTS for Admin Product retrieval with filtering, search, and pagination.
