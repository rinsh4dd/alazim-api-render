-- Migration: 0063_Create_PR_GET_CUSTOMIZATION_TEMPLATES.sql
-- Description: Creates stored procedure dbo.PR_GET_CUSTOMIZATION_TEMPLATES for listing, searching (@SEARCH), pagination, and single lookup.
