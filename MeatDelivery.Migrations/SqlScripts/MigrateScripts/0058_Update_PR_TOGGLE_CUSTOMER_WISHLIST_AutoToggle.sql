-- Migration: 0058_Update_PR_TOGGLE_CUSTOMER_WISHLIST_AutoToggle.sql
-- Description: Updates PR_TOGGLE_CUSTOMER_WISHLIST for high performance (removed extra product select query).
