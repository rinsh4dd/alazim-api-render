-- =============================================================================
-- MIGRATION SCRIPT: 0129_Create_PR_TRACK_ORDER.sql
-- Description: Creates PR_TRACK_ORDER Stored Procedure for Order Tracking in UAE Local Time.
-- =============================================================================
...
BEGIN
    ...
    BEGIN
        RAISERROR('Order not found or does not belong to the specified user.', 16, 1);
        RETURN;
    END;
