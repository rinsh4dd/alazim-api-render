-- Migration: 0050_Create_PR_GET_FRESH_PICKS_PRODUCTS.sql
-- Description: Creates stored procedure dbo.PR_GET_FRESH_PICKS_PRODUCTS to retrieve active, non-deleted fresh arrival products without pagination.
...
BEGIN
    ...
    WHERE p.IS_ACTIVE = 1
      AND p.IS_DELETED = 0
      AND p.CREATED_AT >= DATEADD(DAY, -10, SYSUTCDATETIME())
