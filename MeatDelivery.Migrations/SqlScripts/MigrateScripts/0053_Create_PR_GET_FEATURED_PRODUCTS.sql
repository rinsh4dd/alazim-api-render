-- Migration: 0053_Create_PR_GET_FEATURED_PRODUCTS.sql
-- Description: Creates stored procedure PR_GET_FEATURED_PRODUCTS to retrieve all active, non-deleted featured products.

IF OBJECT_ID('dbo.PR_GET_FEATURED_PRODUCTS', 'P') IS NOT NULL
    DROP PROCEDURE dbo.PR_GET_FEATURED_PRODUCTS;
GO

EXEC('
CREATE PROCEDURE dbo.PR_GET_FEATURED_PRODUCTS
AS
BEGIN
    SET NOCOUNT ON;
