...
namespace MeatDelivery.Application.Interfaces.Repositories.Authentication
{
    public interface IOtpVerificationRepository
    {
        ...
        Task<CreateOtpVerificationResult> CreateOtpVerificationAsync(string countryCode, string mobileNumber, string otpHash, string purpose, DateTime expiresAt, int maxAttempts = 5, Guid? challengeId = null);
