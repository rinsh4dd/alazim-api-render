...
namespace MeatDelivery.Application.Interfaces.Repositories.Product
{
    public interface IProductRepository
    {
        ...
        Task<(List<CustomerProductDto> Items, int TotalRecords)> GetCustomerProductsAsync(long? customerUserId, GetCustomerProductsQueryDto query, CancellationToken cancellationToken = default);
        ...
        Task<(List<ProductPriceHistoryDto> Items, int TotalRecords)> GetPriceHistoryAsync(GetPriceHistoryQueryDto query, CancellationToken cancellationToken = default);
