...
namespace MeatDelivery.Application.Interfaces.Repositories.Product
{
    public interface IProductRepository
    {
        ...
        Task<(List<CustomerProductDto> Items, int TotalRecords)> GetCustomerProductsAsync(GetCustomerProductsQueryDto query, CancellationToken cancellationToken = default);
