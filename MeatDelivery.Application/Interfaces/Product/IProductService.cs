...
namespace MeatDelivery.Application.Interfaces.Product
{
    public interface IProductService
    {
        ...
        Task<PagedResponse<List<CustomerProductDto>>> GetCustomerProductsAsync(long? customerUserId, GetCustomerProductsQueryDto query, CancellationToken cancellationToken = default);
        ...
        Task<PagedResponse<List<ProductPriceHistoryDto>>> GetPriceHistoryAsync(GetPriceHistoryQueryDto query, CancellationToken cancellationToken = default);
